...
public final class TFTSMenus{
	...
	public static final RegistryObject<MenuType<FishPreparationTableMenu>> FISH_PREPARATION_TABLE = MENUS.register("fish_preparation_table", () ->
			new MenuType<>(FishPreparationTableMenu::new, FeatureFlagSet.of()));
